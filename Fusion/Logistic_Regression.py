...
if __name__=='__main__':
    ...
    scores_lr_for_file= numpy.asarray(Scores)
    numpy.save('scores_lr.npy', scores_lr_for_file)
    r_labels= numpy.asarray(real_labels)
    numpy.save('real_labels.npy', r_labels)
