...
if __name__=='__main__':
    ...
    N_0 = class_columns(0, DTR, LTR)
    N_1 = class_columns(1, DTR, LTR)
    tied_covariance = (1/DTR.shape[1])*(covariance_matrix_0*N_0 + covariance_matrix_1*N_1)
    
    logS = logpdf_GAU_ND(DTE, mean_0, tied_covariance)
    logS = numpy.concatenate((logS, logpdf_GAU_ND(DTE, mean_1, tied_covariance)), axis=0)
